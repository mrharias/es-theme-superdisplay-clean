# es-theme-superdisplay-clean
# MrHArias
OVERVIEW

This ZIP package contains the Super Display Clean version theme that is to be used within Emulation Station.
...
atomisware,futurepinball,model2,model3,mugen,n3ds,naomi,naomi2,openbor,pcgames,pinballfx2,popcap,taititypex,touhou-project,zinc
